  ...
  exports['default'] = Ember['default'].Route.extend({
    model: function () {
      return {
        version: "0.90.27",
        fecha: "2015-03-02",
        link_mac: "https://dl.dropboxusercontent.com/u/1335422/releases/pilas-engine/0.90.27/pilas-engine-0.90.27.dmg",
        link_windows: "https://dl.dropboxusercontent.com/u/1335422/releases/pilas-engine/0.90.27/pilas-engine_0.90.27.exe",
...
define('pilas-website-test/templates/descargas', ['exports', 'ember'], function (exports, Ember) {
  ...
  helpers = this.merge(helpers, Ember['default'].Handlebars.helpers); data = data || {};
    ...
    if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
    data.buffer.push(" ):</p>\n  </div>\n\n  <div class='row'>\n    <ul id='descargas'>\n      <li><img width=16 height=16 src='images/windows-b20d4c3c2319a1eac941caccd73df076.png'> <a ");
    ...
    data.buffer.push(">Windows</a></li>\n      <li><img width=16 height=16 src='images/platform_mac-d0b345459ae4508abc2b6da45dade8e1.png'> <a ");
    data.buffer.push(escapeExpression((helper = helpers.bindAttr || (depth0 && depth0.bindAttr),options={hash:{
      'href': ("link_mac")
    },hashTypes:{'href': "STRING"},hashContexts:{'href': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "bindAttr", options))));
    data.buffer.push(">Mac OS X</a></li>\n      <li><img width=16 height=16 src='images/huayra-8df85fb2813365f29fa9a3f6b322a11a.png'> <img width=16 height=16 src='images/ico-ubuntu-029927f1fd1c359ba8dc0bd888e81fdd.png'/> <a ");
    data.buffer.push(escapeExpression((helper = helpers.bindAttr || (depth0 && depth0.bindAttr),options={hash:{
      'href': ("link_deb")
    },hashTypes:{'href': "STRING"},hashContexts:{'href': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "bindAttr", options))));
    data.buffer.push(">Huayra o Ubuntu</a></li>\n    </ul>\n  </div>\n\n  <div class='row'>\n\n    <div class=\"col-lg-3\"></div>\n\n    <div class=\"col-lg-6\">\n    <p>También podés encontrar las versiones anteriores de pilas en <a href='https://www.dropbox.com/sh/pv0vu4id6dqqojh/AACy-7fqG1CpJlHXbqgOR2q6a?dl=0' target=\"_blank\">este link</a>.</p>\n    </div>\n\n    <div class=\"col-lg-3\"></div>\n  </div>\n</div>\n");
    return buffer;
